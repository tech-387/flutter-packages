...
import io.flutter.plugins.videoplayer.VideoPlayerLoggerOptions;
...
public class PlatformViewVideoPlayer extends VideoPlayer {
  ...
  public static PlatformViewVideoPlayer create(
      ...
      @NonNull VideoPlayerLoggerOptions videoPlayerLoggerOptions
      ) {
    return new PlatformViewVideoPlayer(
        events,
        asset.getMediaItem(),
        options,
            () ->  VideoPlayer.constructExoPlayer(context, asset, options, videoPlayerBufferOptions, videoPlayerLoggerOptions));
  }
