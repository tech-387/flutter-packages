...
data class CreateMessage (
  ...
  val bufferOptions: BufferOptionsMessage? = null,
  val loggerOptions: LoggerOptionsMessage? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CreateMessage {
      ...
      val bufferOptions = pigeonVar_list[5] as BufferOptionsMessage?
      val loggerOptions = pigeonVar_list[6] as LoggerOptionsMessage?
      return CreateMessage(asset, uri, packageName, formatHint, httpHeaders, bufferOptions, loggerOptions)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as CreateMessage
    return MessagesPigeonUtils.deepEquals(this.asset, other.asset) && MessagesPigeonUtils.deepEquals(this.uri, other.uri) && MessagesPigeonUtils.deepEquals(this.packageName, other.packageName) && MessagesPigeonUtils.deepEquals(this.formatHint, other.formatHint) && MessagesPigeonUtils.deepEquals(this.httpHeaders, other.httpHeaders) && MessagesPigeonUtils.deepEquals(this.bufferOptions, other.bufferOptions) && MessagesPigeonUtils.deepEquals(this.loggerOptions, other.loggerOptions)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.asset)
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.bufferOptions)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.loggerOptions)
    return result
  }
}

/** Generated class from Pigeon that represents data sent in messages. */
data class CacheOptionsMessage (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CacheOptionsMessage {
      val enableCache = pigeonVar_list[0] as Boolean
      val cacheDirectory = pigeonVar_list[1] as String
      val maxCacheBytes = pigeonVar_list[2] as Long
      val maxFileBytes = pigeonVar_list[3] as Long
      return CacheOptionsMessage(enableCache, cacheDirectory, maxCacheBytes, maxFileBytes)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as CacheOptionsMessage
    return MessagesPigeonUtils.deepEquals(this.enableCache, other.enableCache) && MessagesPigeonUtils.deepEquals(this.cacheDirectory, other.cacheDirectory) && MessagesPigeonUtils.deepEquals(this.maxCacheBytes, other.maxCacheBytes) && MessagesPigeonUtils.deepEquals(this.maxFileBytes, other.maxFileBytes)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableCache)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.cacheDirectory)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.maxCacheBytes)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.maxFileBytes)
    return result
  }
}

/** Generated class from Pigeon that represents data sent in messages. */
data class BufferOptionsMessage (
  val minBufferMs: Long,
  val maxBufferMs: Long,
  val bufferForPlaybackMs: Long,
  val bufferForPlaybackAfterRebufferMs: Long,
  val minDurationForQualityIncreaseMs: Long,
  val maxDurationForQualityDecreaseMs: Long,
  val minDurationToRetainAfterDiscardMs: Long,
  val maxWidthToDiscard: Long,
  val maxHeightToDiscard: Long,
  val bandwidthFraction: Double,
  val bufferedFractionToLiveEdgeForQualityIncrease: Double
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): BufferOptionsMessage {
      ...
      val bufferForPlaybackAfterRebufferMs = pigeonVar_list[3] as Long
      val minDurationForQualityIncreaseMs = pigeonVar_list[4] as Long
      val maxDurationForQualityDecreaseMs = pigeonVar_list[5] as Long
      val minDurationToRetainAfterDiscardMs = pigeonVar_list[6] as Long
      val maxWidthToDiscard = pigeonVar_list[7] as Long
      val maxHeightToDiscard = pigeonVar_list[8] as Long
      val bandwidthFraction = pigeonVar_list[9] as Double
      val bufferedFractionToLiveEdgeForQualityIncrease = pigeonVar_list[10] as Double
      return BufferOptionsMessage(minBufferMs, maxBufferMs, bufferForPlaybackMs, bufferForPlaybackAfterRebufferMs, minDurationForQualityIncreaseMs, maxDurationForQualityDecreaseMs, minDurationToRetainAfterDiscardMs, maxWidthToDiscard, maxHeightToDiscard, bandwidthFraction, bufferedFractionToLiveEdgeForQualityIncrease)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as BufferOptionsMessage
    return MessagesPigeonUtils.deepEquals(this.minBufferMs, other.minBufferMs) && MessagesPigeonUtils.deepEquals(this.maxBufferMs, other.maxBufferMs) && MessagesPigeonUtils.deepEquals(this.bufferForPlaybackMs, other.bufferForPlaybackMs) && MessagesPigeonUtils.deepEquals(this.bufferForPlaybackAfterRebufferMs, other.bufferForPlaybackAfterRebufferMs) && MessagesPigeonUtils.deepEquals(this.minDurationForQualityIncreaseMs, other.minDurationForQualityIncreaseMs) && MessagesPigeonUtils.deepEquals(this.maxDurationForQualityDecreaseMs, other.maxDurationForQualityDecreaseMs) && MessagesPigeonUtils.deepEquals(this.minDurationToRetainAfterDiscardMs, other.minDurationToRetainAfterDiscardMs) && MessagesPigeonUtils.deepEquals(this.maxWidthToDiscard, other.maxWidthToDiscard) && MessagesPigeonUtils.deepEquals(this.maxHeightToDiscard, other.maxHeightToDiscard) && MessagesPigeonUtils.deepEquals(this.bandwidthFraction, other.bandwidthFraction) && MessagesPigeonUtils.deepEquals(this.bufferedFractionToLiveEdgeForQualityIncrease, other.bufferedFractionToLiveEdgeForQualityIncrease)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.minDurationForQualityIncreaseMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.maxDurationForQualityDecreaseMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.minDurationToRetainAfterDiscardMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.maxWidthToDiscard)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.maxHeightToDiscard)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.bandwidthFraction)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.bufferedFractionToLiveEdgeForQualityIncrease)
    return result
  }
}

/** Generated class from Pigeon that represents data sent in messages. */
data class LoggerOptionsMessage (
  val enableTransferListenerLogs: Boolean,
  val enableBandwidthListenerLogs: Boolean,
  val enableAdaptiveTrackSelectionLogs: Boolean,
  val enableCacheDataSourceLogs: Boolean
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): LoggerOptionsMessage {
      val enableTransferListenerLogs = pigeonVar_list[0] as Boolean
      val enableBandwidthListenerLogs = pigeonVar_list[1] as Boolean
      val enableAdaptiveTrackSelectionLogs = pigeonVar_list[2] as Boolean
      val enableCacheDataSourceLogs = pigeonVar_list[3] as Boolean
      return LoggerOptionsMessage(enableTransferListenerLogs, enableBandwidthListenerLogs, enableAdaptiveTrackSelectionLogs, enableCacheDataSourceLogs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as LoggerOptionsMessage
    return MessagesPigeonUtils.deepEquals(this.enableTransferListenerLogs, other.enableTransferListenerLogs) && MessagesPigeonUtils.deepEquals(this.enableBandwidthListenerLogs, other.enableBandwidthListenerLogs) && MessagesPigeonUtils.deepEquals(this.enableAdaptiveTrackSelectionLogs, other.enableAdaptiveTrackSelectionLogs) && MessagesPigeonUtils.deepEquals(this.enableCacheDataSourceLogs, other.enableCacheDataSourceLogs)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableTransferListenerLogs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableBandwidthListenerLogs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableAdaptiveTrackSelectionLogs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableCacheDataSourceLogs)
    return result
  }
}
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CreationOptions {
      ...
      val bufferOptions = pigeonVar_list[4] as BufferOptionsMessage?
      val loggerOptions = pigeonVar_list[5] as LoggerOptionsMessage?
      val backBufferDurationMs = pigeonVar_list[6] as Long?
      return CreationOptions(uri, formatHint, httpHeaders, userAgent, bufferOptions, loggerOptions, backBufferDurationMs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      132.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          CacheOptionsMessage.fromList(it)
        }
      }
      133.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          BufferOptionsMessage.fromList(it)
        }
      }
      134.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          LoggerOptionsMessage.fromList(it)
        }
      }
      135.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is CacheOptionsMessage -> {
        stream.write(132)
        writeValue(stream, value.toList())
      }
      is BufferOptionsMessage -> {
        stream.write(133)
        writeValue(stream, value.toList())
      }
      is LoggerOptionsMessage -> {
        stream.write(134)
        writeValue(stream, value.toList())
      }
...
interface AndroidVideoPlayerApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: AndroidVideoPlayerApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setCacheOptions$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
