...
+ (FVPCacheOptionsMessage *)fromList:(NSArray *)list;
+ (nullable FVPCacheOptionsMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FVPBufferOptionsMessage ()
+ (FVPBufferOptionsMessage *)fromList:(NSArray *)list;
+ (nullable FVPBufferOptionsMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (FVPCreateMessage *)fromList:(NSArray *)list {
  ...
  pigeonResult.bufferOptions = [FVPBufferOptionsMessage nullableFromList:(GetNullableObjectAtIndex(list, 5))];
  return pigeonResult;
}
+ (nullable FVPCreateMessage *)nullableFromList:(NSArray *)list {
...
- (NSArray *)toList {
  return @[
    ...
    (self.bufferOptions ? [self.bufferOptions toList] : [NSNull null]),
  ];
}
@end
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FVPBufferOptionsMessage class]]) {
    [self writeByte:128];
...
void SetUpFVPAVFoundationVideoPlayerApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setCacheOptions"
        binaryMessenger:binaryMessenger
        codec:FVPAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
