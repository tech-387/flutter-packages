...
class BufferOptionsMessage {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(preferredForwardBufferDuration, other.preferredForwardBufferDuration) && _deepEquals(canUseNetworkResourcesForLiveStreamingWhilePaused, other.canUseNetworkResourcesForLiveStreamingWhilePaused) && _deepEquals(automaticallyWaitsToMinimizeStalling, other.automaticallyWaitsToMinimizeStalling);
  }
...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> setCacheOptions(CacheOptionsMessage msg) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setCacheOptions$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> preloadIntoCache(String uri, int segmentCount, Map<String?, String?> httpHeaders) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.preloadIntoCache$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> cancelPreload(String uri) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.cancelPreload$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
